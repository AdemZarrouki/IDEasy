...
* https://github.com/devonfw/IDEasy/issues/913[#913]: Add support for SQuirrel SQL Client (squirrel-sql commandlet)
...
* https://github.com/devonfw/IDEasy/issues/1747[#1747]: macOS x64 error during installation: Bad CPU type in executable
* https://github.com/devonfw/IDEasy/issues/1738[#1738]: FileAccess.delete follows links
* https://github.com/devonfw/IDEasy/issues/1151[#1151]: Mac on ARM thinks the architecture is x86 and therefore does not download arm64 releases causing poor performance
* https://github.com/devonfw/IDEasy/issues/1770[#1770]: IDEasy setup is broken (license agreement question not printed)
* https://github.com/devonfw/IDEasy/issues/1771[#1771]: Maven 3.9.1x versions not available
* https://github.com/devonfw/IDEasy/issues/1647[#1647]: Wrong CVEs reported for rancher desktop
* https://github.com/devonfw/IDEasy/issues/1363[#1363]: ide --force uninstall should also remove plugins
* https://github.com/devonfw/IDEasy/issues/1761[#1761]: Install version pattern not working
* https://github.com/devonfw/IDEasy/issues/1687[#1687]: JLine causes warning about restricted method
* https://github.com/devonfw/IDEasy/issues/1458[#1458]: ide create should implicitly icd to projecty
* https://github.com/devonfw/IDEasy/issues/1752[#1752]: Merging vscode user settings json file throws exception
* https://github.com/devonfw/IDEasy/issues/1795[#1795]: Create installation script to simplify setup of IDEasy

The full list of changes for this release can be found in https://github.com/devonfw/IDEasy/milestone/42?closed=1[milestone 2026.04.001].
...
* https://github.com/devonfw/IDEasy/issues/1699[#1699]: Add function to verify that the provided git URL is valid
...
* https://github.com/devonfw/IDEasy/issues/1683[#1683]: Updated the link for bug-ticket creation that's shown when an error is encountered
...
* https://github.com/devonfw/IDEasy/issues/1144[#1144]: CVE: adapt IDEasy to consider security.json files to warn user - see https://github.com/devonfw/IDEasy/blob/main/documentation/security.adoc[security] documentation
* https://github.com/devonfw/IDEasy/issues/1145[#1145]: CVE: suggest version update to user
...
* https://github.com/devonfw/IDEasy/issues/1584[#1584]: IllegalArgumentException on ide update
